                    ...
                    <div className="hero-padding">
                        <div className="text-white text-center">
                            ...
                            <div className="d-grid justify-content-center gap-4 d-lg-flex pt-4">
                                <button class="btn btn-light1" type="button"><Link to="#contact" style={{textDecoration: 'none', color: '#400c7b'}}>Hire Me<span className="ps-3"><BsEmojiSmile size={20} /></span></Link></button>
                                <button type="button" class="btn-outline-light1"><Link to="" style={{color: '#fff'}}>Download Cv<span className="ps-2"><AiOutlineDownload size={20} /></span></Link></button>
                            </div>                        
                        </div>
                    </div>
                </div>
