                    ...
                    <div className="hero-padding">
                        <div className="text-white text-center">
                            ...
                            <div className="d-grid justify-content-center gap-4 d-lg-flex pt-4">
                                ...
                                <button type="button" className="btn btn-outline-light1"><Link to="" style={{textDecoration: 'none'}}>Download Cv<span className="ps-2"><AiOutlineDownload size={20} /></span></Link></button>
                            </div>                        
                        </div>
                    </div>
                </div>
